...
LOCAL_SRC_FILES  := FLA_Gemm_task.c FLA_Hemm_task.c FLA_Her2k_task.c FLA_Herk_task.c FLA_Symm_task.c FLA_Syr2k_task.c FLA_Syrk_task.c FLA_Trmm_task.c FLA_Trsm_task.c
