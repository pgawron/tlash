  ...
  for ( irep = 0 ; irep < nrepeats; irep++ ){
    ...
    *dtime = FLA_Clock();
    ...
    case 0:
      ...
      REF_Syrk_ut( FLA_ONE, A, FLA_ONE, C );
      break;
    ...
    case 1:{
      ...
      case FLA_ALG_UNBLOCKED:
        FLA_Syrk_ut_unb_var1( FLA_ONE, A, FLA_ONE, C );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Syrk_ut_blk_var1( FLA_ONE, A, FLA_ONE, C, cntl_syrk_var );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 2:{
      ...
      switch( type ){
      case FLA_ALG_UNBLOCKED:
        FLA_Syrk_ut_unb_var2( FLA_ONE, A, FLA_ONE, C );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Syrk_ut_blk_var2( FLA_ONE, A, FLA_ONE, C, cntl_syrk_var );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 3:{
      ...
      switch( type ){
      case FLA_ALG_UNBLOCKED:
        FLA_Syrk_ut_unb_var3( FLA_ONE, A, FLA_ONE, C );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Syrk_ut_blk_var3( FLA_ONE, A, FLA_ONE, C, cntl_syrk_var );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 4:{
      ...
      switch( type ){
      case FLA_ALG_UNBLOCKED:
        FLA_Syrk_ut_unb_var4( FLA_ONE, A, FLA_ONE, C );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Syrk_ut_blk_var4( FLA_ONE, A, FLA_ONE, C, cntl_syrk_var );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 5:{
      ...
      switch( type ){
      case FLA_ALG_UNBLOCKED:
        FLA_Syrk_ut_unb_var5( FLA_ONE, A, FLA_ONE, C );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Syrk_ut_blk_var5( FLA_ONE, A, FLA_ONE, C, cntl_syrk_var );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 6:{
      ...
      switch( type ){
      case FLA_ALG_UNBLOCKED:
        FLA_Syrk_ut_unb_var6( FLA_ONE, A, FLA_ONE, C );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Syrk_ut_blk_var6( FLA_ONE, A, FLA_ONE, C, cntl_syrk_var );
        break;
      default:
        printf("trouble\n");
      }
