...
CURRENT_DIR_NAME := trmm
CURRENT_SUB_DIRS := front llc llh lln llt luc luh lun lut rlc rlh rln rlt ruc ruh run rut

# Source files local to this fragment
LOCAL_SRC_FILES  := 

# Add the fragment's local source files to the _global_variable_ variable.
MK_BLAS_SRC += $(addprefix $(PARENT_PATH)/$(CURRENT_DIR_NAME)/, $(LOCAL_SRC_FILES))
