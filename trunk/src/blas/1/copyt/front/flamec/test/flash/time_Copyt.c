    ...
    *dtime = FLA_Clock();
    ...
    case 0:{
      ...
      case FLA_ALG_REFERENCE:
        REF_Copyt( FLA_NO_TRANSPOSE, A_flat, C_flat );
        break;
      case FLA_ALG_FRONT:
        FLASH_Copyt( FLA_NO_TRANSPOSE, A, C );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 1:{
      switch( type ){
      case FLA_ALG_REFERENCE:
        REF_Copyt( FLA_TRANSPOSE, A_flat, C_flat );
        break;
      case FLA_ALG_FRONT:
        FLASH_Copyt( FLA_TRANSPOSE, A, C );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 2:{
      switch( type ){
      case FLA_ALG_REFERENCE:
        REF_Copyt( FLA_CONJ_NO_TRANSPOSE, A_flat, C_flat );
        break;
      case FLA_ALG_FRONT:
        FLASH_Copyt( FLA_CONJ_NO_TRANSPOSE, A, C );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 3:{
      switch( type ){
      case FLA_ALG_REFERENCE:
        REF_Copyt( FLA_CONJ_TRANSPOSE, A_flat, C_flat );
        break;
      case FLA_ALG_FRONT:
        FLASH_Copyt( FLA_CONJ_TRANSPOSE, A, C );
        break;
      default:
        printf("trouble\n");
      }
