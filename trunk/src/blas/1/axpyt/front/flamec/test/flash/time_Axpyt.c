    ...
    *dtime = FLA_Clock();
    ...
    case 0:{
      ...
      case FLA_ALG_REFERENCE:
        REF_Axpyt( FLA_NO_TRANSPOSE, FLA_ONE, A_flat, C_flat );
        break;
      case FLA_ALG_FRONT:
        FLASH_Axpyt( FLA_NO_TRANSPOSE, FLA_ONE, A, C );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 1:{
      switch( type ){
      case FLA_ALG_REFERENCE:
        REF_Axpyt( FLA_TRANSPOSE, FLA_ONE, A_flat, C_flat );
        break;
      case FLA_ALG_FRONT:
        FLASH_Axpyt( FLA_TRANSPOSE, FLA_ONE, A, C );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 2:{
      switch( type ){
      case FLA_ALG_REFERENCE:
        REF_Axpyt( FLA_CONJ_NO_TRANSPOSE, FLA_ONE, A_flat, C_flat );
        break;
      case FLA_ALG_FRONT:
        FLASH_Axpyt( FLA_CONJ_NO_TRANSPOSE, FLA_ONE, A, C );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 3:{
      switch( type ){
      case FLA_ALG_REFERENCE:
        REF_Axpyt( FLA_CONJ_TRANSPOSE, FLA_ONE, A_flat, C_flat );
        break;
      case FLA_ALG_FRONT:
        FLASH_Axpyt( FLA_CONJ_TRANSPOSE, FLA_ONE, A, C );
        break;
      default:
        printf("trouble\n");
      }
