    ...
    *dtime = FLA_Clock();
    ...
    case 0:{
      ...
      case FLA_ALG_REFERENCE:
        REF_Scalr( FLA_LOWER_TRIANGULAR, FLA_ONE, A_flat );
        break;
      case FLA_ALG_FRONT:
        FLASH_Scalr( FLA_LOWER_TRIANGULAR, FLA_ONE, A );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 1:{
      switch( type ){
      case FLA_ALG_REFERENCE:
        REF_Scalr( FLA_UPPER_TRIANGULAR, FLA_ONE, A_flat );
        break;
      case FLA_ALG_FRONT:
        FLASH_Scalr( FLA_UPPER_TRIANGULAR, FLA_ONE, A );
        break;
      default:
        printf("trouble\n");
      }
