    ...
    *dtime = FLA_Clock();
    ...
    case 1:{
      ...
      case FLA_ALG_UNBLOCKED:
        FLA_Trsm_llh_unb_var1( FLA_NONUNIT_DIAG, FLA_ONE, A, C );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Trsm_llh_blk_var1( FLA_NONUNIT_DIAG, FLA_ONE, A, C, cntl_trsm_var );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 2:{
      ...
      switch( type ){
      case FLA_ALG_UNBLOCKED:
        FLA_Trsm_llh_unb_var2( FLA_NONUNIT_DIAG, FLA_ONE, A, C );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Trsm_llh_blk_var2( FLA_NONUNIT_DIAG, FLA_ONE, A, C, cntl_trsm_var );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 3:{
      ...
      switch( type ){
      case FLA_ALG_UNBLOCKED:
        FLA_Trsm_llh_unb_var3( FLA_NONUNIT_DIAG, FLA_ONE, A, C );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Trsm_llh_blk_var3( FLA_NONUNIT_DIAG, FLA_ONE, A, C, cntl_trsm_var );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 4:{
      ...
      switch( type ){
      case FLA_ALG_UNBLOCKED:
        FLA_Trsm_llh_unb_var4( FLA_NONUNIT_DIAG, FLA_ONE, A, C );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Trsm_llh_blk_var4( FLA_NONUNIT_DIAG, FLA_ONE, A, C, cntl_trsm_var );
        break;
      default:
        printf("trouble\n");
      }
