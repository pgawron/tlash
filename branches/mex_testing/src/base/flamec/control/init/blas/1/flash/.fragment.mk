...
LOCAL_SRC_FILES  := FLASH_Axpy_cntl_init.c FLASH_Axpyt_cntl_init.c FLASH_Copy_cntl_init.c FLASH_Copyr_cntl_init.c FLASH_Copyt_cntl_init.c FLASH_Scal_cntl_init.c FLASH_Scalr_cntl_init.c
