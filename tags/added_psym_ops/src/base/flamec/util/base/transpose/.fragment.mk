...
CURRENT_DIR_NAME := transpose
CURRENT_SUB_DIRS := 

# Source files local to this fragment
LOCAL_SRC_FILES  := FLA_Swap_t_blk_var1.c FLA_Swap_t_blk_var2.c FLA_Transpose.c FLA_Transpose_blk_var1.c FLA_Transpose_blk_var2.c FLA_Transpose_unb_var1.c FLA_Transpose_unb_var2.c
