...
CURRENT_DIR_NAME := fla
CURRENT_SUB_DIRS := 

# Source files local to this fragment
LOCAL_SRC_FILES  := FLA_Apply_CAQ2_UT_cntl_init.c FLA_Apply_Q2_UT_cntl_init.c FLA_Apply_QUD_UT_cntl_init.c FLA_Apply_Q_UT_cntl_init.c FLA_Apply_pivots_cntl_init.c FLA_Bidiag_UT_cntl_init.c FLA_CAQR2_UT_cntl_init.c FLA_Chol_cntl_init.c FLA_Eig_gest_cntl_init.c FLA_Hess_UT_cntl_init.c FLA_LQ_UT_cntl_init.c FLA_LU_nopiv_cntl_init.c FLA_LU_piv_cntl_init.c FLA_Lyap_cntl_init.c FLA_QR2_UT_cntl_init.c FLA_QR_UT_cntl_init.c FLA_SPDinv_cntl_init.c FLA_Sylv_cntl_init.c FLA_Tridiag_UT_cntl_init.c FLA_Trinv_cntl_init.c FLA_Ttmm_cntl_init.c FLA_UDdate_UT_cntl_init.c
