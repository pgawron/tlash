...
CURRENT_DIR_NAME := gpu
CURRENT_SUB_DIRS := 

# Source files local to this fragment
LOCAL_SRC_FILES  := FLA_Gemm_external_gpu.c FLA_Hemm_external_gpu.c FLA_Her2k_external_gpu.c FLA_Herk_external_gpu.c FLA_Symm_external_gpu.c FLA_Syr2k_external_gpu.c FLA_Syrk_external_gpu.c FLA_Trmm_external_gpu.c FLA_Trsm_external_gpu.c
