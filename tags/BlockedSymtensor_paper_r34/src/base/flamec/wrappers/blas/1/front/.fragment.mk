...
CURRENT_DIR_NAME := front
CURRENT_SUB_DIRS := 

# Source files local to this fragment
LOCAL_SRC_FILES  := FLA_Amax.c FLA_Asum.c FLA_Axpyrt.c FLA_Axpys.c FLA_Copyrt.c FLA_Dot.c FLA_Dot2cs.c FLA_Dot2s.c FLA_Dotc.c FLA_Dotcs.c FLA_Dots.c FLA_Inv_scal.c FLA_Inv_scalc.c FLA_Nrm2.c FLA_Scalc.c FLA_Swap.c FLA_Swapt.c
