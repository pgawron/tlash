...
CURRENT_SUB_DIRS := mch

# Source files local to this fragment
LOCAL_SRC_FILES  := FLA_Apply_diag_matrix.c FLA_Form_perm_matrix.c FLA_Hev_2x2.c FLA_Hevv_2x2.c FLA_Househ2_UT.c FLA_Househ2s_UT.c FLA_Househ3UD_UT.c FLA_LU_find_zero_on_diagonal.c FLA_Mach_params.c FLA_Norm1_tridiag.c FLA_Pythag2.c FLA_Pythag3.c FLA_Shift_pivots_to.c FLA_Sort_evd.c FLA_Sort_svd.c FLA_Sv_2x2.c FLA_Svv_2x2.c FLA_Wilkshift_tridiag.c
