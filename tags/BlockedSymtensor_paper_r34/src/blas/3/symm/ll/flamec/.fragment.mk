...
LOCAL_SRC_FILES  := FLA_Symm_ll_blk_var1.c FLA_Symm_ll_blk_var10.c FLA_Symm_ll_blk_var2.c FLA_Symm_ll_blk_var3.c FLA_Symm_ll_blk_var4.c FLA_Symm_ll_blk_var5.c FLA_Symm_ll_blk_var6.c FLA_Symm_ll_blk_var7.c FLA_Symm_ll_blk_var8.c FLA_Symm_ll_blk_var9.c FLA_Symm_ll_unb_var1.c FLA_Symm_ll_unb_var10.c FLA_Symm_ll_unb_var2.c FLA_Symm_ll_unb_var3.c FLA_Symm_ll_unb_var4.c FLA_Symm_ll_unb_var5.c FLA_Symm_ll_unb_var6.c FLA_Symm_ll_unb_var7.c FLA_Symm_ll_unb_var8.c FLA_Symm_ll_unb_var9.c

# Add the fragment's local source files to the _global_variable_ variable.
MK_BLAS_FLAMEC_SRC += $(addprefix $(PARENT_PATH)/$(CURRENT_DIR_NAME)/, $(LOCAL_SRC_FILES))
