...
LOCAL_SRC_FILES  := FLASH_FS_incpiv_aux1.c FLASH_FS_incpiv_aux2.c FLASH_LU_incpiv_var1.c FLASH_LU_incpiv_var2.c FLASH_SA_FS.c FLASH_SA_LU.c FLASH_Trsm_piv.c
