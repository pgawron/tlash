    ...
    *dtime = FLA_Clock();
    ...
    case 1:{
      ...
      case FLA_ALG_UNBLOCKED:
        FLA_Trinv_lu_unb_var1( A );
        break;
      case FLA_ALG_UNB_OPT:
        FLA_Trinv_lu_opt_var1( A );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Trinv_lu_blk_var1( A, cntl_trinv_var );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 2:{
      switch( type ){
      case FLA_ALG_UNBLOCKED:
        FLA_Trinv_lu_unb_var2( A );
        break;
      case FLA_ALG_UNB_OPT:
        FLA_Trinv_lu_opt_var2( A );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Trinv_lu_blk_var2( A, cntl_trinv_var );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 3:{
      switch( type ){
      case FLA_ALG_UNBLOCKED:
        FLA_Trinv_lu_unb_var3( A );
        break;
      case FLA_ALG_UNB_OPT:
        FLA_Trinv_lu_opt_var3( A );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Trinv_lu_blk_var3( A, cntl_trinv_var );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 4:{
      switch( type ){
      case FLA_ALG_UNBLOCKED:
        FLA_Trinv_lu_unb_var4( A );
        break;
      case FLA_ALG_UNB_OPT:
        FLA_Trinv_lu_opt_var4( A );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Trinv_lu_blk_var4( A, cntl_trinv_var );
        break;
      default:
        printf("trouble\n");
      }
