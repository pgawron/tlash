               ...
               double *dtime, double *diff, double *gflops )
{
  ...
  if (
       ( type == FLA_ALG_UNBLOCKED && variant > 4 ) ||
       ( type == FLA_ALG_UNB_OPT   && variant > 4 ) ||
       ( type == FLA_ALG_BLOCKED   && variant > 4 ) ||
       FALSE
     )
  {
    *gflops = 0.0;
  ...
  for ( irep = 0 ; irep < n_repeats; irep++ )
  {
    ...
    *dtime = FLA_Clock();
    ...
    case 1:
    {
      switch( type )
      {
        case FLA_ALG_UNBLOCKED:
          FLA_Lyap_n_unb_var1( isgn, A, C );
          break;
        case FLA_ALG_UNB_OPT:
          FLA_Lyap_n_opt_var1( isgn, A, C );
          break;
        case FLA_ALG_BLOCKED:
          FLA_Lyap_n_blk_var1( isgn, A, C, scale, cntl_lyap_blk );
          break;
      }
      break;
    }
    ...
    case 2:
    {
      ...
      {
        case FLA_ALG_UNBLOCKED:
          FLA_Lyap_n_unb_var2( isgn, A, C );
          break;
        case FLA_ALG_UNB_OPT:
          FLA_Lyap_n_opt_var2( isgn, A, C );
          break;
        case FLA_ALG_BLOCKED:
          FLA_Lyap_n_blk_var2( isgn, A, C, scale, cntl_lyap_blk );
          break;
      }
      break;
    }
    ...
    case 3:
    {
      ...
      {
        case FLA_ALG_UNBLOCKED:
          FLA_Lyap_n_unb_var3( isgn, A, C );
          break;
        case FLA_ALG_UNB_OPT:
          FLA_Lyap_n_opt_var3( isgn, A, C );
          break;
        case FLA_ALG_BLOCKED:
          FLA_Lyap_n_blk_var3( isgn, A, C, scale, cntl_lyap_blk );
          break;
      }
      break;
    }
    ...
    case 4:
    {
      ...
      {
        case FLA_ALG_UNBLOCKED:
          FLA_Lyap_n_unb_var4( isgn, A, C );
          break;
        case FLA_ALG_UNB_OPT:
          FLA_Lyap_n_opt_var4( isgn, A, C );
          break;
        case FLA_ALG_BLOCKED:
          FLA_Lyap_n_blk_var4( isgn, A, C, scale, cntl_lyap_blk );
          break;
      }
      break;
    }
