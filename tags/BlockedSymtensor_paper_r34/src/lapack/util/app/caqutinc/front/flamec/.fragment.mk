...
LOCAL_SRC_FILES  := FLASH_Apply_CAQ_UT_inc.c FLASH_Apply_CAQ_UT_inc_create_workspace.c FLA_Apply_CAQ_UT_inc_apply_panels.c FLA_Apply_CAQ_UT_inc_internal.c FLA_Apply_CAQ_UT_inc_lhfc.c
