    ...
    *dtime = FLA_Clock();
    ...
    case 1:
    {
      ...
      case FLA_ALG_UNBLOCKED:
        FLA_Eig_gest_il_unb_var1( A, Y, B );
        break;
      case FLA_ALG_UNB_OPT:
        FLA_Eig_gest_il_opt_var1( A, Y, B );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Eig_gest_il_blk_var1( A, Y, B, cntl_eig_gest_var );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 2:
    {
      ...
      {
      case FLA_ALG_UNBLOCKED:
        FLA_Eig_gest_il_unb_var2( A, Y, B );
        break;
      case FLA_ALG_UNB_OPT:
        FLA_Eig_gest_il_opt_var2( A, Y, B );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Eig_gest_il_blk_var2( A, Y, B, cntl_eig_gest_var );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 3:
    {
      ...
      {
      case FLA_ALG_UNBLOCKED:
        FLA_Eig_gest_il_unb_var3( A, Y, B );
        break;
      case FLA_ALG_UNB_OPT:
        FLA_Eig_gest_il_opt_var3( A, Y, B );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Eig_gest_il_blk_var3( A, Y, B, cntl_eig_gest_var );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 4:
    {
      ...
      {
      case FLA_ALG_UNBLOCKED:
        FLA_Eig_gest_il_unb_var4( A, Y, B );
        break;
      case FLA_ALG_UNB_OPT:
        FLA_Eig_gest_il_opt_var4( A, Y, B );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Eig_gest_il_blk_var4( A, Y, B, cntl_eig_gest_var );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 5:
    {
      ...
      {
      case FLA_ALG_UNBLOCKED:
        FLA_Eig_gest_il_unb_var5( A, Y, B );
        break;
      case FLA_ALG_UNB_OPT:
        FLA_Eig_gest_il_opt_var5( A, Y, B );
        break;
      case FLA_ALG_BLOCKED:
        FLA_Eig_gest_il_blk_var5( A, Y, B, cntl_eig_gest_var );
        break;
      default:
        printf("trouble\n");
      }
