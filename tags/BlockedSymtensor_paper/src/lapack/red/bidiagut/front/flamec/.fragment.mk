...
LOCAL_SRC_FILES  := FLA_Bidiag_UT.c FLA_Bidiag_UT_create_T.c FLA_Bidiag_UT_extract_diagonals.c FLA_Bidiag_UT_form_U.c FLA_Bidiag_UT_form_V.c FLA_Bidiag_UT_internal.c FLA_Bidiag_UT_realify.c FLA_Bidiag_UT_recover_tau.c FLA_Bidiag_UT_u.c
