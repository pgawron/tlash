...
LOCAL_SRC_FILES  := FLA_Sylv_nn_blk_var1.c FLA_Sylv_nn_blk_var10.c FLA_Sylv_nn_blk_var11.c FLA_Sylv_nn_blk_var12.c FLA_Sylv_nn_blk_var13.c FLA_Sylv_nn_blk_var14.c FLA_Sylv_nn_blk_var15.c FLA_Sylv_nn_blk_var16.c FLA_Sylv_nn_blk_var17.c FLA_Sylv_nn_blk_var18.c FLA_Sylv_nn_blk_var2.c FLA_Sylv_nn_blk_var3.c FLA_Sylv_nn_blk_var4.c FLA_Sylv_nn_blk_var5.c FLA_Sylv_nn_blk_var6.c FLA_Sylv_nn_blk_var7.c FLA_Sylv_nn_blk_var8.c FLA_Sylv_nn_blk_var9.c FLA_Sylv_nn_opt_var1.c FLA_Sylv_nn_opt_var10.c FLA_Sylv_nn_opt_var11.c FLA_Sylv_nn_opt_var12.c FLA_Sylv_nn_opt_var13.c FLA_Sylv_nn_opt_var14.c FLA_Sylv_nn_opt_var15.c FLA_Sylv_nn_opt_var16.c FLA_Sylv_nn_opt_var17.c FLA_Sylv_nn_opt_var18.c FLA_Sylv_nn_opt_var2.c FLA_Sylv_nn_opt_var3.c FLA_Sylv_nn_opt_var4.c FLA_Sylv_nn_opt_var5.c FLA_Sylv_nn_opt_var6.c FLA_Sylv_nn_opt_var7.c FLA_Sylv_nn_opt_var8.c FLA_Sylv_nn_opt_var9.c

# Add the fragment's local source files to the _global_variable_ variable.
MK_LAPACK_FLAMEC_SRC += $(addprefix $(PARENT_PATH)/$(CURRENT_DIR_NAME)/, $(LOCAL_SRC_FILES))
