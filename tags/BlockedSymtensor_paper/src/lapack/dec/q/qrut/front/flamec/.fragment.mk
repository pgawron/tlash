...
LOCAL_SRC_FILES  := FLASH_QR_UT.c FLASH_QR_UT_create_hier_matrices.c FLASH_QR_UT_solve.c FLA_QR_UT.c FLA_QR_UT_copy_internal.c FLA_QR_UT_create_T.c FLA_QR_UT_form_Q.c FLA_QR_UT_internal.c FLA_QR_UT_recover_tau.c FLA_QR_UT_solve.c
