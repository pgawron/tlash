...
FLA_Error FLA_Hevd_lv_unb_var3( dim_t n_iter_max, FLA_Obj A, FLA_Obj l, dim_t k_accum, dim_t b_alg )
{
	...
	FLA_Obj_create( dt,      mn_A-1, n_G, 0, 0, &G );
	...
	FLA_Tevd_v_opt_var3( n_iter_max, d, e, G, A, b_alg );
