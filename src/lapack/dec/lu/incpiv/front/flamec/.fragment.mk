...
LOCAL_SRC_FILES  := FLASH_FS_incpiv.c FLASH_LU_incpiv.c FLASH_LU_incpiv_create_hier_matrices.c FLASH_LU_incpiv_noopt.c FLASH_LU_incpiv_opt1.c FLASH_LU_incpiv_solve.c
