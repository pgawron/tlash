...
LOCAL_SRC_FILES  := FLASH_LQ_UT.c FLASH_LQ_UT_create_hier_matrices.c FLASH_LQ_UT_solve.c FLA_LQ_UT.c FLA_LQ_UT_create_T.c FLA_LQ_UT_form_Q.c FLA_LQ_UT_internal.c FLA_LQ_UT_recover_tau.c FLA_LQ_UT_solve.c
