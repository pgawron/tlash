...
#ifdef PRINTF
if ( ij_begin == 0 )
printf( "FLA_Tevd_v_opd_var4: beginning new sweep (ij_begin = %d)\n", ij_begin );
#endif
			...
			if ( r_val == FLA_FAILURE )
			{
				...
				{
#ifdef PRINTF
printf( "FLA_Tevd_v_opd_var4: subdiagonal is completely zero.\n" );
printf( "FLA_Tevd_v_opd_var4: Francis iteration is done!\n" );
#endif
					done = TRUE;
				}
...
#ifdef PRINTF
printf( "FLA_Tevd_v_opd_var4: ij_begin = %d\n", ij_begin );
printf( "FLA_Tevd_v_opd_var4: ijTL     = %d\n", ijTL );
printf( "FLA_Tevd_v_opd_var4: ijBR     = %d\n", ijBR );
printf( "FLA_Tevd_v_opd_var4: m_A11    = %d\n", m_A11 );
#endif
...
#ifdef PRINTF
printf( "FLA_Tevd_v_opd_var4: deflations observed       = %d\n", n_deflations );
printf( "FLA_Tevd_v_opd_var4: total deflations observed = %d\n", total_deflations );
printf( "FLA_Tevd_v_opd_var4: num iterations            = %d\n", n_iter_perf );
#endif
			...
			{
#ifdef PRINTF
printf( "FLA_Tevd_v_opd_var4: reached maximum total number of iterations: %d\n", n_iter_prev );
#endif
				FLA_Abort();
				//return FLA_FAILURE;
			}
...
#ifdef PRINTF
printf( "FLA_Tevd_v_opd_var4: applying %d sets of Givens rotations\n", n_iter_perf_sweep_max );
#endif
...
printf( "FLA_Tevd_v_opz_var4: beginning new sweep (ij_begin = %d)\n", ij_begin );
			...
			if ( r_val == FLA_FAILURE )
			{
				...
				{
#ifdef PRINTF
printf( "FLA_Tevd_v_opz_var4: subdiagonal is completely zero.\n" );
printf( "FLA_Tevd_v_opz_var4: Francis iteration is done!\n" );
#endif
					done = TRUE;
				}
...
#ifdef PRINTF
printf( "FLA_Tevd_v_opz_var4: ij_begin = %d\n", ij_begin );
printf( "FLA_Tevd_v_opz_var4: ijTL     = %d\n", ijTL );
printf( "FLA_Tevd_v_opz_var4: ijBR     = %d\n", ijBR );
printf( "FLA_Tevd_v_opz_var4: m_A11    = %d\n", m_A11 );
#endif
...
#ifdef PRINTF
printf( "FLA_Tevd_v_opz_var4: deflations observed       = %d\n", n_deflations );
printf( "FLA_Tevd_v_opz_var4: total deflations observed = %d\n", total_deflations );
printf( "FLA_Tevd_v_opz_var4: num iterations            = %d\n", n_iter_perf );
#endif
			...
			{
#ifdef PRINTF
printf( "FLA_Tevd_v_opz_var4: reached maximum total number of iterations: %d\n", n_iter_prev );
#endif
				FLA_Abort();
				//return FLA_FAILURE;
			}
...
#ifdef PRINTF
printf( "FLA_Tevd_v_opz_var4: applying %d sets of Givens rotations\n", n_iter_perf_sweep_max );
#endif
