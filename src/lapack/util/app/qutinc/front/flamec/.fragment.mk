...
LOCAL_SRC_FILES  := FLASH_Apply_Q_UT_inc.c FLASH_Apply_Q_UT_inc_create_workspace.c FLA_Apply_Q_UT_inc_internal.c FLA_Apply_Q_UT_inc_lhfc.c FLA_Apply_Q_UT_inc_lnfc.c
