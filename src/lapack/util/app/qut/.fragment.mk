...
CURRENT_DIR_NAME := qut
CURRENT_SUB_DIRS := front lhbc lhbr lhfc lhfr lnbc lnbr lnfc lnfr rhbc rhbr rhfc rhfr rnbc rnbr rnfc rnfr

# Source files local to this fragment
LOCAL_SRC_FILES  := 

# Add the fragment's local source files to the _global_variable_ variable.
MK_LAPACK_SRC += $(addprefix $(PARENT_PATH)/$(CURRENT_DIR_NAME)/, $(LOCAL_SRC_FILES))
