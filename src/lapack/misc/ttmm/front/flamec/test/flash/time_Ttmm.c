...
FLA_Error REF_Ttmm( FLA_Trans trans, FLA_Obj A );
    ...
    *dtime = FLA_Clock();
    ...
    case 0:{
      ...
      case FLA_ALG_REFERENCE:
        REF_Ttmm( FLA_LOWER_TRIANGULAR, A_flat );
        break;
      case FLA_ALG_FRONT:
        FLASH_Ttmm( FLA_LOWER_TRIANGULAR, A );
        break;
      default:
        printf("trouble\n");
      }
    ...
    case 1:{
      switch( type ){
      case FLA_ALG_REFERENCE:
        REF_Ttmm( FLA_UPPER_TRIANGULAR, A_flat );
        break;
      case FLA_ALG_FRONT:
        FLASH_Ttmm( FLA_UPPER_TRIANGULAR, A );
        break;
      default:
        printf("trouble\n");
      }
