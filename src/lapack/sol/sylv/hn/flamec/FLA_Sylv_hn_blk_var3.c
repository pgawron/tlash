...
FLA_Error FLA_Sylv_hn_blk_var3( FLA_Obj isgn, FLA_Obj A, FLA_Obj B, FLA_Obj C, FLA_Obj scale, fla_sylv_t* cntl )
{
  ...
  while ( FLA_Obj_length( ATL ) < FLA_Obj_length( A ) ){
    ...
    // Loop Invariant:
    // CTL = sylv( ATL', BTL, CTL )
    // CTR = CTR
    // CBL = sylv( ABR', BTL, CBL -  ATR' * sylv( ATL', BTL, CTL ) )
    // CBR = CBR

    /*------------------------------------------------------------*/

    // C01 = sylv( A00', B11, C01 -/+ C00 * B01 );
    ...
    // C11 = sylv( A11', B11, C11 - A01' * C01 -/+ C10 * B01 );
    FLA_Gemm_internal( FLA_NO_TRANSPOSE, FLA_NO_TRANSPOSE,
    ...
    // C21 = sylv( A22', B11, C21 - A12' * C11 - A02' * C01 -/+ C20 * B01 );
    FLA_Gemm_internal( FLA_NO_TRANSPOSE, FLA_NO_TRANSPOSE,
