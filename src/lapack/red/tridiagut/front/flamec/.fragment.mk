...
LOCAL_SRC_FILES  := FLA_Tridiag_UT.c FLA_Tridiag_UT_create_T.c FLA_Tridiag_UT_extract_diagonals.c FLA_Tridiag_UT_form_Q.c FLA_Tridiag_UT_internal.c FLA_Tridiag_UT_l.c FLA_Tridiag_UT_realify.c FLA_Tridiag_UT_recover_tau.c FLA_Tridiag_UT_shift_U.c FLA_Tridiag_UT_u.c
