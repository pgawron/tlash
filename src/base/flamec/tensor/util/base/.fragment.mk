...
LOCAL_SRC_FILES  := FLA_Adjust_2D_Info.c FLA_Binomial.c FLA_Check_Unique_Index.c FLA_Compare_Pairwise_Sort.c FLA_Get_unique_info.c FLA_Permute_array.c FLA_Random_symm_tensor.c FLA_Random_tensor.c FLA_Set_tensor_permutation.c FLA_Set_tensor_stride.c FLA_Set_zero_tensor.c FLA_TIndex_to_LinIndex.c FLA_Ttm_flops.c
