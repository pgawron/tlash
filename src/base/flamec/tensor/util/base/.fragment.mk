...
LOCAL_SRC_FILES  := FLA_Adjust_2D_Info.c FLA_Binomial.c FLA_Compare_Pairwise_Sort.c FLA_Get_unique_info.c FLA_Random_sym_tensor.c FLA_Random_tensor.c FLA_Set_tensor_stride.c FLA_Set_zero_tensor.c FLA_TIndex_to_LinIndex.c FLA_Ttm_flops.c FLA_array_elemwise_product.c FLA_array_elemwise_quotient.c FLA_array_product.c FLA_print_array.c TLA_create_part_obj.c TLA_destroy_part_obj.c TLA_sym_init_nonsymmetric.c
