...
FLA_Error FLA_Sttsm_A_single( FLA_Obj alpha, FLA_Obj A, FLA_Obj beta, FLA_Obj B, FLA_Obj C )
{
...
FLA_Error FLA_Sttsm_A( FLA_Obj alpha, FLA_Obj A, FLA_Obj beta, FLA_Obj B, FLA_Obj C )
{
	FLA_Sttsm_A_single( alpha, A, , beta, B, C);
